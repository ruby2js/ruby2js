...
server {
    ...
    # Cross-origin isolation for SharedArrayBuffer (WebContainers editor)
    # is handled by coi-serviceworker.js in the editor directory,
    # so we don't set COOP/COEP globally (which would block iframe embedding).
