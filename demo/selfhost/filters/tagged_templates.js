// Transpiled Ruby2JS Filter: TaggedTemplates
// Generated from ../../lib/ruby2js/filter/tagged_templates.rb
//
...
Object.defineProperty(
  ...
  const TaggedTemplates = (() => {
    ...
    function on_send(node) {
      ...
      let tagged_methods = _options.template_literal_tags ?? [
        "html",
        "css"
      ];
      ...
      if (tagged_methods.includes(method) && args.length === 1) {
        ...
        return S("taglit", s("sym", method), strnode)
      } else {
        return process_children(node)
      }
    };

    return {initialize, on_send}
  })();
...
Ruby2JS.Filter.TaggedTemplates = TaggedTemplates;

// Setup function to bind filter infrastructure
TaggedTemplates._setup = function(opts) {
...
export { TaggedTemplates as default, TaggedTemplates };
